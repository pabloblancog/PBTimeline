...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../PBTimeline/Timeline/Themes/Minimal/TimelineMinimalHeaderView.xib"
  install_resource "${PODS_ROOT}/../PBTimeline/Timeline/Themes/Minimal/TimelineMinimalTableViewCell.xib"
  install_resource "${PODS_ROOT}/../PBTimeline/Timeline/Themes/Regular/TimelineRegularHeaderView.xib"
