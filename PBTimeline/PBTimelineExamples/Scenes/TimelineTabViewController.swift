...
class TimelineTabViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    let events: [TimelineEvent] = [TimelineEvent(id: 1,
                                                 date: Date(),
                                   ...
                                   TimelineEvent(id: 9,
                                                 date: Date().addingDays(days: 4)!,
                                                 title: "Pizza garden",
                                                 description: "Description for event 9",
                                                 category: TimelineEventCategory.food,
                                                 price: 24.60)]
    
    let deliveryEvents: [TimelineEvent] = [TimelineEvent(id: 1,
                                                         date: Date(),
    ...
    let timeTrackingEvents: [TimelineEvent] = [TimelineEvent(id: 1,
                                                             date: Date(),
                                                             title: "Workday start",
                                                             description: "08:30h",
